					...
					<fieldset>
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<a class="col-sm-4 btn btn-primary" id="scanMicroInverters"><i class="fa fa-search"></i> {{Scan des micro-onduleurs}}</a>
							</div>
...
<script>
    ...
    $('#scanMicroInverters').on('click', function() {
        // Récupère l'ID de l'équipement depuis l'élément actif
        var eqLogicId = $('.eqLogic:visible').attr('data-eqlogic_id'); // Note : data-eqlogic-id au lieu de data-eqLogic_id
        if (!eqLogicId) {
