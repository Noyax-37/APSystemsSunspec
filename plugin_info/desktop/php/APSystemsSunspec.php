                ...
                <form class="form-horizontal">
                    <fieldset>
                        <div class="col-lg-6">
                            ...
                            <div class="form-group ecu-container">
                                <label class="col-sm-4 control-label">{{Stop interrogation (HH:MM ou #sunset#)}}
                                    <sup><i class="fas fa-question-circle tooltips" title="{{Saisir l'heure souhaitée de fin d'interrogation des MO soit par l'ajout de l'heure soit par #sunset# soit par la sélection d'une commande. #sunset# ou une commande peut être décalée en saisissant - XX en minutes}}"></i></sup>
                                </label>
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="stopPollingStart" placeholder="22:00 ou #sunset# ou sélection d'une commande" />
                                        <span class="input-group-btn">
                                            <a class="btn btn-default" id="bt_stopPollingStartCmd" title="{{Sélectionner une commande}}">
                            ...
                            <div class="form-group ecu-container">
                                <label class="col-sm-4 control-label">{{Start interrogation (HH:MM ou #sunrise#)}}
                                    <sup><i class="fas fa-question-circle tooltips" title="{{Saisir l'heure souhaitée de début d'interrogation des MO soit par l'ajout de l'heure soit par #sunrise# soit par la sélection d'une commande. #sunrise# ou une commande peut être décalée en saisissant + XX en minutes}}"></i></sup>
                                </label>
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="stopPollingEnd" placeholder="06:00 ou #sunrise# ou sélection d'une commande" />
                                        <span class="input-group-btn">
                                            <a class="btn btn-default" id="bt_stopPollingEndCmd" title="{{Sélectionner une commande}}">
                                                <i class="fa fa-list-alt"></i>
                                            </a>
                                        </span>
                                    </div>
